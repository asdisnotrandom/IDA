...
use crate::veri_tipleri::{AracMod::{self, Otonom}, GelenTelemetri, GidenTelemetri, GpsVeri, ImuVeri, LidarVeri, MotorVeri};
...
const HEDEF1X: f64 = 0.0;
const HEDEF1Y: f64 = 0.0;
const HEDEF2X: f64 = 0.0;
const HEDEF2Y: f64 = 0.0;
const HEDEF3X: f64 = 0.0;
const HEDEF3Y: f64 = 0.0;
const HEDEF4X: f64 = 0.0;
const HEDEF4Y: f64 = 0.0;
